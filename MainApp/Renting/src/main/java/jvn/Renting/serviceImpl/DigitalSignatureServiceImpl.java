...
public class DigitalSignatureServiceImpl implements DigitalSignatureService {
    ...
    @Value("${KEYSTORE:tls/certs/renting/keystore/renting.keystore.p12}")
    private String keyStorePath;

    @Value("${KEYSTORE_PASSWORD:renting_pass}")
    private String password;

    @Value("${KEYSTORE_ALIAS:renting}")
    private String alias;

    @Value("${TRUSTSTORE:tls/certs/renting/keystore/renting.truststore.p12}")
    private String trustStorePath;

    @Value("${TRUSTSTORE_PASSWORD:renting_pass}")
