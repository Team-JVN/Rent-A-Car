...
export class RentRequestService {
  ...
  public accept(rentRequest: RentRequest): any {
    return this.httpClient.put(this.url + "/" + rentRequest.id, {
      status: "PAID",
    });
  }
  ...
  public getRentInfoFeedback(rentInfoId: number, rentRequestId: number) {
    return this.httpClient.get(
      this.url + "/" + rentRequestId + "/rent-info/" + rentInfoId + "/feedback"
    );
  }

  public pay(rentRequestId: number, rentInfoId: number): any {
    return this.httpClient.put(
      this.url + "/" + rentRequestId + "/rent-info/" + rentInfoId + "/pay",
      null
    );
  }
  ...
  public createComment(
    ...
    return this.httpClient.post(
      this.url + "/" + rentRequestId + "/rent-info/" + rentInfoId + "/comment",
      comment
    );
  }
  ...
  public getAdvertisementEditType(id: number) {
    return this.httpClient.get(
      this.url + "/advertisement/" + id + "/edit-type"
    );
  }
}
